    ...
    emailjs
      .send(
        ...
        import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
        {
          ...
          to_email: "andrescalderonromo@gmail.com",
      ...
      .then(() => {
        setIsLoading(false);
        showAlert({show: true, text: 'El mensaje se envió correctamente',type:'success'})
      ...
      .catch((error) => {
        ...
        setCurrenAnimation('idle')
        console.log(error);
        showAlert({ show: true, text: "No recibí tu mensaje :c",type:'danger' });
      });
  };
        ...
        >
          ...
          <label className="text-black-500 font-semibold">
            ...
            <textarea
              ...
              rows={4}
              className="textarea"
              placeholder="Dejame saber como puedo ayudarte."
              required
              value={form.message}
              onChange={handleChange}
              onFocus={handleFocus}
